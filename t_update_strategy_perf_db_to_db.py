...
parser.add_option( "--source_host", dest="source_host",default='10.32.191.66', type="str",
                  help="source host,  default '10.32.191.66'")

parser.add_option( "--source_table", dest="source_table",default='zzz_pattern_perf_debug', type="str",
                  help="source db table, default zzz_pattern_perf_debug, other options: pattern_perf_forex, pattern_perf ")

parser.add_option( "--dest_host", dest="dest_host",default='127.0.0.1', type="str",
                  help="destination host, default 127.0.0.1")

parser.add_option( "--dest_table", dest="dest_table",default='zzz_pattern_perf_debug', type="str",
                  help="destination db table,  default zzz_pattern_perf_debug, other options: pattern_perf_forex, pattern_perf ")


parser.add_option( "--skip_backup_before_execute", action="store_true",
...
cnx_src = mysql.connector.connect(user='root', password='admin888.@_@',
                              host=source_host,
                              database='ryan_stock_db')
...
cnx_dst = mysql.connector.connect(user='root', password='admin888.@_@',
                              host=dest_host,
                              database='ryan_stock_db')
