...
parser.add_option("-m", "--max_exam_day", dest="max_exam_day",default=221, type="int",
                  help="max_exam_day, 300000 for perf gathering, default 221 for daily ptn checking")
...
parser.add_option("-l", "--local_source", action="store_true",
                  dest="local_source", default=False,
...
cols = ['code',
        'date','op','op_rsn', 'op_strength', 'close_p',
        '2mea','5mea','10mea','20mea','60mea','120mea',
        '2uc','2dc','5uc','5dc','10uc','10dc','20uc','20dc',
