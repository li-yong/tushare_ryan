...
def verify_file_exist_update(hide_pass=True, print_len = True):
    ...
    finlib.Finlib().file_verify(base+"/DAY_Global/KH/*.csv", day=3, hide_pass=True, print_len=False)
...
def verify_price_utd():
    ...
    if len(df[df["datetime"]==today_s]) == 1:
        print("PASS. KH stock price is update to date. /home/ryan/DATA/DAY_Global/KH/00001.KH ")
    else:
        print("FAIL. KH stock price is not update to date. /home/ryan/DATA/DAY_Global/KH/00001.KH ")



    df=pd.read_csv("/home/ryan/DATA/DAY_Global/KH/00007.KH")
    if len(df[df["datetime"]==today_s]) == 1:
        print("PASS. KH stock price is update to date. /home/ryan/DATA/DAY_Global/KH/00007.KH ")
    else:
        print("FAIL. KH stock price is not update to date. /home/ryan/DATA/DAY_Global/KH/00007.KH")
    ...
    if len(df[df["datetime"]==today_s_us]) == 1:
        print("PASS. US stock price is update to date. /home/ryan/DATA/DAY_Global/US/AAPL.US")
    else:
        print("FAIL. US stock price is not update to date. /home/ryan/DATA/DAY_Global/US/AAPL.US")
