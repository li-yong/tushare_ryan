...
def convert(input_csv, code):
    df = pd.read_csv(input_csv, skiprows=1, converters={'date': str}, header=None, names=['date', 'open', 'high', 'low', 'close', 'vol'])
...
if __name__ == '__main__':
    ...
    #########################
    dow_f = '/home/ryan/DATA/DAY_Global/US_INDEX/dow.csv'
    sp_f = '/home/ryan/DATA/DAY_Global/US_INDEX/sp500.csv'
