...
class Finlib_indicator:
    ...
    # get stock price under 60 days sma.
    #  The input macd_selection_D.csv" generated by 
    #  python t_daily_indicator_kdj_macd.py --indicator MACD --period D
    def get_under_sma60(self, period='D'):
        file = "/home/ryan/DATA/result/macd_selection_"+period+".csv"
        df = pd.read_csv(file, encoding="utf-8")
        df_under_sma60 = df[df['reason'].str.contains(constant.UNDER_SMA60)]
        return(df_under_sma60)
