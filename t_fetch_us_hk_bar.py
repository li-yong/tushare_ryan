...
if fetch_hk:
    ...
    df_GH = df_instrument.query("market==71 and category==2").reset_index().drop('index', axis=1)  # 568

    df_KH = df_KH.append(df_GH).sort_values(by='code').reset_index().drop('index', axis=1)
