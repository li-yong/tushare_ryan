...
not_selected_dict = {
    "AG": {
        # 'df_yunxian_sell':{'op':'B','file':result+'/ag_junxian_barstyle_yunxian_sell.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        ...
        # 'df_jincha_minor':{'op':'B','file':result+'/ag_junxian_barstyle_jincha_minor.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        # 'df_jincha_major':{'op':'B','file':result+'/ag_junxian_barstyle_jincha_major.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        # 'df_very_strong_up_trend':{'op':'B','file':result+'/ag_junxian_barstyle_very_strong_up_trend.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        # 'df_very_strong_down_trend':{'op':'B','file':result+'/ag_junxian_barstyle_very_strong_down_trend.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        ...
        # 'df_max_daily_decrease':{'op':'B','file':result_today + "/" + "talib_and_pv_no_db_filter_" + stock_global + ".csv",'column':'op_rsn','kw':'_max_daily_decrease',"term": "SHORT TERM", "price": "NA" },
        ...
        # 'df_max_daily_increase':{'op':'B','file':result_today + "/" + "talib_and_pv_no_db_filter_" + stock_global + ".csv",'column':'op_rsn','kw':'_max_daily_increase',"term": "SHORT TERM", "price": "NA" },
        # 'df_macd_m':{'op':'B','file':result+'/macd_selection_M.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        # 'df_macd_w':{'op':'B','file':result+'/macd_selection_W.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        # 'df_macd_d':{'op':'B','file':result+'/macd_selection_D.csv','column':'','kw':'',"term": "SHORT TERM", "price": "NA" },
        #
        #
