...
if __name__ == '__main__':
    ...
    logging.info(
        str(len_myonly) + " out of " + str(len_both) + " in my hs300, they possible will be added to hs300 next time")
    logging.info(finlib.Finlib().pprint(df=df_myonly))

    df_hs300only = df_merged[
        df_merged['_merge'] == "to_be_replaced"]  # possible will be removed from hs300 index next time
